...
library(tidyverse)
#base.path = "Q:/.shortcut-targets-by-id/1FP9BlrAC2EltlqKM3ounRs2COTiTK12G/nNIL genotype data Jim and Tao/Output/"
base.path = "C:/Users/jholland/Box/nNIL genotype data Jim and Tao/Output/"
```
...
```{r}
chip.results = read.csv(paste0(base.path, "nNIL_chipdata_HMMgridSearchSummary.csv")) %>%
...
```{r}
ggsave(filename = paste0(base.path, "nNIL chip data hmm grid search results.tiff"), width = 10, height = 8, units = "in", dpi = 300, bg = "white")
ggsave(filename = paste0(base.path, "nNIL chip data hmm grid search results.png"), width = 10, height = 8, units = "in", dpi = 300, bg = "white")
