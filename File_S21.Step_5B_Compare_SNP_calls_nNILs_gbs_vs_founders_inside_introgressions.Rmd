...
```{r}
ggsave(intro.coverage.plot.both,filename = "C:/Users/jholland/Box/nNIL genotype data Jim and Tao/Output/Introgression coverage by genome position.tiff", dpi = 300, width = 10, height = 8, units = "in")
```
