...
```{r}
write.csv(intro.summary2, file = "C:/Users/jholland/Box/nNIL genotype data Jim and Tao/nNIL_data_supplement/File_S18.Individual_Introgressions_gbs.csv", row.names = F, quote = F)
```
