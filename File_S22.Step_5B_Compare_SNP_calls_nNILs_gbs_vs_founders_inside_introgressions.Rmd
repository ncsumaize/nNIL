...
```{r}
intro.calls = fread("C:/Users/jholland/Box/nNIL genotype data Jim and Tao/nNIL_data_supplement/File_S19.nNIL_gbs_HMM_introgressionCalls_full_set.csv")
```
...
```{r}
ggsave(intro.coverage.plot,filename = "C:/Users/jholland/Box/nNIL genotype data Jim and Tao/Output/Introgression coverage by genome position.tiff", dpi = 300, width = 10, height = 8, units = "in")
```
